	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				<el-form-item>
					<el-input v-model="filters.systemCode" size="small" width="50" placeholder="系统编码"></el-input>
				</el-form-item>
				<el-form-item>
					<el-input v-model="filters.funcCode" size="small" placeholder="功能编码"></el-input>
				</el-form-item>
				<el-form-item>
					<el-input v-model="filters.funcName" size="small" placeholder="功能名称"></el-input>
				</el-form-item>
				<el-form-item>
		...
		<el-table :data="appSystem" border highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;" height="390">
			...
			<el-table-column prop="type" label="权限类型" width="150"></el-table-column>
			...
			<el-table-column prop="parentCode" label="上级编码" width="100"></el-table-column>
			<el-table-column prop="isLeaf" label="叶子节点" width="100"></el-table-column>
