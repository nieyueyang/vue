	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				...
				<el-form-item>
					<el-button type="primary" v-on:click="clear">清除</el-button>
				</el-form-item>
				<el-form-item>
		...
		<el-table :data="role" border highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;" height="390">
			...
			<el-table-column key="5" prop="isactive" label="是否启用" width="100" sortable></el-table-column>
...
    	</el-pagination>
		...
		<el-dialog title="编辑" customClass="customWidth" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="角色编码" prop="roleCode">
					<el-col :span="15">
						<el-input type="text"  v-model="editForm.roleCode"  size="small"></el-input>
					</el-col>	
				</el-form-item>
				<el-form-item label="角色名称" prop="roleName">
					<el-col :span="15">
